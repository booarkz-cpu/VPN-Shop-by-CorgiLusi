...
# Historical compatibility marker: VERSION="20.0.9"
# Historical compatibility marker: VERSION="20.0.8"
# Historical compatibility marker: VERSION="20.0.7"
...
ARTIFACT="remnawave_vpn_shop_v20_0_12_full_release.zip"
